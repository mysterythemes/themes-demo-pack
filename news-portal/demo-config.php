...
function mt_demo_importer_config(){
	...
	$fashion_demo_slug = 'news-portal-pro-fashion';
	...
	$demo_config 	= array(
		...
		'news-portal-pro-fashion' => array(
			...
			'theme_slug'        	=> $fashion_demo_slug,
			'version' 				=> '1.1.5',
			'theme_description' 	=> esc_html__( 'Ultimate responsive premium magazine WordPress Theme.', 'mystery-demo-importer' ),
			'xml_file'     			=> $git_url . 'news-portal-pro-fashion/'.$fashion_demo_slug.'.xml',
			'theme_settings' 		=> $git_url . 'news-portal-pro-fashion/'.$fashion_demo_slug.'-export.dat',
			'widgets_file'  		=> $git_url . 'news-portal-pro-fashion/'.$fashion_demo_slug.'-widgets.wie',
			'preview_screen'		=> $git_url . 'news-portal-pro-fashion/screenshot.png',
			'preview_url'			=> 'https://demo.mysterythemes.com/'.$fashion_demo_slug,
			'is_shop'				=> false,
			'theme_type'        	=> array( 'premium', 'blog', 'magazine' ),
			'show_on_front'     	=> 'page',
			'home_title'  			=> 'Home',
		...
		'news-portal-pro-blog' => array(
			...
			'version' 				=> '1.1.5',
			'theme_description' 	=> esc_html__( 'Ultimate responsive premium magazine WordPress Theme.', 'mystery-demo-importer' ),
			'xml_file'     			=> $git_url . 'news-portal-pro-blog/'.$pro_theme_slug.'.xml',
			'theme_settings' 		=> $git_url . 'news-portal-pro-blog/'.$pro_theme_slug.'-export.dat',
			'widgets_file'  		=> $git_url . 'news-portal-pro-blog/'.$pro_theme_slug.'-widgets.wie',
			'preview_screen'		=> $git_url . 'news-portal-pro-blog/screenshot.png',
			'preview_url'			=> 'https://demo.mysterythemes.com/'.$pro_theme_slug.'/-blog',
			'is_shop'				=> false,
			'theme_type'        	=> array( 'premium', 'blog', 'magazine' ),
			'show_on_front'     	=> 'page',
			'home_title'  			=> 'Home',
			...
			'widgets_data_update'    => array(
				...
				'multi_checkbox' => array(
					'category' => array(
						'news_portal_slider' => array(
							2 => array(
								'slider_cat_ids'	=> array( 'Slider' )
							),
						),
						'news_portal_list_posts' => array(
							2 => array(
								'block_cat_ids'	=> array( 'Lifestyle' )
							),
						),
						'news_portal_fullwidth_posts' => array(
							2 => array(
								'block_cat_ids'	=> array( 'Photography', 'Technology', 'Wildlife' )
							),
						),
						'news_portal_carousel' => array(
							2 => array(
								'block_cat_ids'	=> array( 'Food', 'Photography', 'Wildlife' )
							),
						)
					)
				)
